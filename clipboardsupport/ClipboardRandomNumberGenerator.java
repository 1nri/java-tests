...
public class ClipboardRandomNumberGenerator extends JFrame {
    ...
    public ClipboardRandomNumberGenerator() {
        setTitle("Clipboard Random Number Generator");
        setSize(300, 250);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                while (generating) {
                    ...
                    copyToClipboard(Integer.toString(randomNumber));
                    try {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                ClipboardRandomNumberGenerator generator = new ClipboardRandomNumberGenerator();
